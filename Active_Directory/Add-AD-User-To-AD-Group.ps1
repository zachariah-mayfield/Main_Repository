...
If ($Environment -eq "Prod") {
    ...
    $Key = (& "C:\Program Files (x86)\CyberArk\ApplicationPasswordSdk\CLIPasswordSDK.exe" GetPassword /p AppDescs.AppID=DevProd-ServiceNowMID-ProcessFlow /p Query="Safe=Application_Admin_Prod;Folder=Root;Object=Application-Active_Directory-ad_xxx" /o Password)
